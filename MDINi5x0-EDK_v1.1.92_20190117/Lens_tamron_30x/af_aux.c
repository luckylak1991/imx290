...
static void AfDataExtractODMdata(PAF_CTRL_PARAM pCTRL)
{
	...
	stAFFILT.FLToB = stAFFILT.HPFa+stAFFILT.VPFa + stAFFILT.HPFb+stAFFILT.VPFb;
	//SPOT
	stAFFILT.FLToH = stAFFILT.HPFa+stAFFILT.VPFa;
	//DARK
	//stAFFILT.FLToH = stAFFILT.HPFa+stAFFILT.VPFa + stAFFILT.HPFb+stAFFILT.VPFb;

	stAFFILT.YSUM = (pCTRL->stFILT.YSUM)>>0;
	stAFFILT.GAIN = (pCTRL->stFILT.GAIN)>>0;
}
