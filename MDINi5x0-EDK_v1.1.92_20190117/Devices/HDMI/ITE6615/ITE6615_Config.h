...
#define _Input_RGB_QuantizationRange_   IT6615_RGB_RANGE_FULL      // RGB_RANGE_LIMIT, RGB_RANGE_FULL
#define _Input_Video_AspectRatio_       AR_16_9              // AR_4_3, AR_16_9, AR_14_9

// COMMON OUTPUT CONFIG //
#define _Output_ColorSpace_             YUV444          // RGB444, YUV422, YUV444, YUV420 ( only if the input color mode is also YUV420 )
...
#define _Output_YUV_QuantizationRange_  IT6615_YUV_RANGE_LIMIT // YUV_RANGE_LIMIT, YUV_RANGE_FULL
#define _Output_RGB_QuantizationRange_  IT6615_RGB_RANGE_FULL	// RGB_RANGE_FULL, RGB_RANGE_LIMIT

// HDMI AVI Infoframe - Extended Colorimetry CONFIG
#define _Output_ExtendedColorimetry_Enable_ 0           // 1 = Enable, 0 = Disable
#define _Output_ExtendedColorimetry_Format_ BT2020cYCC  // AdobeRGB BT2020cYCC BT2020YCC
                                                        // xvYCC601 xvYCC709 sYCC601 AdobeYCC601,

// COMMON INPUT DATA PROCESSING CONFIG
#define _Input_Enable_DualMode_         1               // TTL/LVDS Dual Input = 1,  TTL/LVDS Single Input = 0
#define _Input_Enable_DualMode_Mode_    MODE_LEFTRIGHT  // MODE_ODDEVEN/MODE_LEFTRIGHT
...
#define _TTL_Enable_DDR_        1   // 1 : Input Enable DDR
...
#define _ENABLE_6615_SYNC_EMBEDDED_FUNCTIONS_  1
#endif
...
#define TTL_ICLKHDly    2   // 0...3 for input clk delay
#define TTL_ICLKLDly    2   // 0...3 for input clk delay
...
#define SSCLPCLKDly     1   // 0..3
#define SSCHPCLKDly     1   // 0..3
...
#define ENABLE_HPD_POLLING          0   // This define for reduce HPD reponse time for HDCP2.2 Comliance Test
