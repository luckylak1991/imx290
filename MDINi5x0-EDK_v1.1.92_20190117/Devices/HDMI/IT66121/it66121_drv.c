...
void InitHDMITX()
{
    ...
    hdmitx_LoadRegSetting((RegSetEntry *)&HDMITX_DeaultAudioInfo_Table);
    hdmitx_LoadRegSetting((RegSetEntry *)&HDMITX_Aud_CHStatus_LPCM_20bit_48Khz);
    hdmitx_LoadRegSetting((RegSetEntry *)&HDMITX_AUD_SPDIF_2ch_24bit);
