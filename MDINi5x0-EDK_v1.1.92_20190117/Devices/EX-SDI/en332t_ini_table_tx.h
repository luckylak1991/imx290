...
//	{ 0x00000065, 0x00420090 }, // BT_DI_POL[17] = 1 : sampled rising edge
	...
	{ 0x000000c3, 0x00000006 },	// TXREFCK clock select
...
//	{ 0x000000d1, 0x00004000 },	// VDI_DI_SEL[11] = 0 : VD_A(C), VD_B(Y)
	...
	{ 0x000000e4, 0x0104a020 },	// Test Pattern Generation ON
...
// ==================================================================================
#define TX_EX270_HD_Size	39
const UINT TX_EX270_HD[TX_EX270_HD_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
...
// ==================================================================================
#define TX_EX270_4M_Size	1
const UINT TX_EX270_4M[TX_EX270_4M_Size][2] = {{0,0}};

// ==================================================================================
// Slave mode
// VD(16bit) to EX-SDI 2.0(135Mbps)
// ==================================================================================
#define TX_EX135_HD_Size	39
const UINT TX_EX135_HD[TX_EX135_HD_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
	                           
	{ 0x00000031, 0x0000f7c7 },	// TSDI_RATE select
	{ 0x00000041, 0x00003800 },	// In-buffer out data select
	{ 0x0000004a, 0x00800050 },	// Internal data MUX selection
	{ 0x00000065, 0x00400090 }, // BT_DI_POL[17] = 0 : sampled falling edge
//	{ 0x00000065, 0x00420090 }, // BT_DI_POL[17] = 1 : sampled rising edge
...
// ==================================================================================
#define TX_3GSDI_Size	2
const UINT TX_3GSDI[TX_3GSDI_Size][2] = {{0,0}};

// ==================================================================================
// Slave mode
// VD(16bit) to EX-SDI 4K(1.485Gbps)
// ==================================================================================
#define TX_EX1G5_4K_Size	50
const UINT TX_EX1G5_4K[TX_EX1G5_4K_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
	...
	{ 0x00000041, 0x00003800 },	// In-buffer out data select
	{ 0x0000004a, 0x00800050 },	// Internal data MUX selection
	{ 0x00000065, 0x00400200 }, // BT_DI_POL[17] = 0 : sampled falling edge
//	{ 0x00000065, 0x00420200 }, // BT_DI_POL[17] = 1 : sampled rising edge
	{ 0x00000094, 0x000010b0 },	// OBUF Rate select
	{ 0x000000c2, 0x00000000 },	// TXFCK clock select
