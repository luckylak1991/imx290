...
// ==================================================================================
#define TXO_HDSDI_Size	32
const UINT TXO_HDSDI[TXO_HDSDI_Size][2]  =
{
	//Address	, Data
	...
	{ 0x00000065, 0x00400090 }, // BT_DI_POL[17] = 0 : sampled falling edge
//	{ 0x00000065, 0x00420090 }, // BT_DI_POL[17] = 1 : sampled rising edge
	{ 0x00000094, 0x000010b0 },	// OBUF Rate select
	{ 0x000000c2, 0x00000000 },	// TXFCK clock select
	{ 0x000000c3, 0x0000000a },	// TXREFCK clock select
	{ 0x000000c5, 0x30000040 },	// Internal clock selection
...
//	{ 0x000000d1, 0x00004000 },	// VDI_DI_SEL[11] = 0 : VD_A(C), VD_B(Y)
	...
	{ 0x000000c5, 0xb00000c0 },	// RPCK_A enable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
	                           
	{ 0x000000c6, 0x00000000 },	// Encoder Disable
	{ 0x000000c6, 0x0000000a },	// Encoder clock select
	{ 0x000000c6, 0x0000001a },	// Encoder Enable 
	...
	{ 0x000000de, 0x0001ffff },	// PCK A Direction
	{ 0x000000c8, 0xc004c004 }, // PCK B enable
//	{ 0x000000de, 0x0001ffff }	// PCK B Direction
	{ 0x000000de, 0x0000fff9 }	// PCK B Direction(ucc enable)
...
// ==================================================================================
#define TXO_EX270_HD_Size	39
const UINT TXO_EX270_HD[TXO_EX270_HD_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
...
//	{ 0x00000065, 0x00420090 }, // BT_DI_POL[17] = 1 : sampled rising edge
	...
	{ 0x000000c5, 0x30000040 },	// Internal clock selection
	{ 0x000000c8, 0x40044004 },	// PCK_A, Internal clock selection
	{ 0x000000ca, 0x06500089 },	// EXSDI Encoder clock select
	{ 0x000000d1, 0x00004800 },	// VDI_DI_SEL[11] = 1 : VD_A(Y), VD_B(C)
//	{ 0x000000d1, 0x00004000 },	// VDI_DI_SEL[11] = 0 : VD_A(C), VD_B(Y)
	...
	{ 0x000000c5, 0xb00000c0 },	// RPCK_A enable
	{ 0x000000ca, 0x16500189 },	// EXD_A, EXM_A enable
...
// ==================================================================================
#define TXO_EX135_HD_Size	39
const UINT TXO_EX135_HD[TXO_EX135_HD_Size][2] =
{
	{ 0x000000c5, 0x00000000},	// RPCK_A Disable
	{ 0x000000c8, 0x40004000},	// VD_A Disable
	{ 0x000000ca, 0x00000000},	// EXD_A, EXM_A Disable
...
// VD(16bit) to EX-SDI 1.0(270Mbps)
// ==================================================================================
#define TXO_EX270_4M_Size	38
const UINT TXO_EX270_4M[TXO_EX270_4M_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
	...
	{ 0x00000041, 0x00003800 },	// In-buffer out data select
	{ 0x0000004a, 0x00800050 },	// Internal data MUX selection
	{ 0x00000065, 0x00006220 }, // BT_DI_POL[17] = 0 : sampled falling edge
//	{ 0x00000065, 0x00026200 }, // BT_DI_POL[17] = 1 : sampled rising edge
...
//	{ 0x000000de, 0x0001dfff }	// PCK B Direction	// hd -> 4k -> 4m(video x)
//	{ 0x000000de, 0x0001ffff }	// PCK B Direction	// hd -> 4k -> 4m(video o)
	{ 0x000000de, 0x0000fff9 }	// PCK B Direction(ucc enable)
...
// ==================================================================================
#define TXO_EX1G5_4K_Size	51
const UINT TXO_EX1G5_4K[TXO_EX1G5_4K_Size][2] =
{
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
	{ 0x000000ca, 0x00000000 },	// EXD_A, EXM_A Disable
	...
	{ 0x0000004a, 0x00800050 },	// Internal data MUX selection
	{ 0x00000065, 0x00006220 }, // BT_DI_POL[17] = 0 : sampled falling edge
//	{ 0x00000065, 0x00026220 }, // BT_DI_POL[17] = 1 : sampled rising edge
	{ 0x00000094, 0x000010b0 },	// OBUF Rate select
	{ 0x000000c2, 0x00000000 },	// TXFCK clock select
	{ 0x000000c3, 0x0000000a },	// TXREFCK clock select
...
//	{ 0x000000d1, 0x00004000 },	// VDI_DI_SEL[11] = 0 : VD_A(C), VD_B(Y)
	{ 0x000000d2, 0x00003005 },	// Internal data MUX selection
	{ 0x000000d3, 0x00000400 },	// Internal data MUX selection
...
// ==================================================================================
#define TXO_3GSDI_Size	31
const UINT TXO_3GSDI[TXO_3GSDI_Size][2] =
{
	//Address	, Data		, Mask
	{ 0x000000c5, 0x00000000 },	// RPCK_A Disable
	{ 0x000000c8, 0x40004000 },	// VD_A Disable
