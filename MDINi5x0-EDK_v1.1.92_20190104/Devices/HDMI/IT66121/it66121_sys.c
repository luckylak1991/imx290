...
extern HDMI_Colorimetry UserColorimetry ;
...
void InitHDMITX_Variable()
{
    HDMITX_InitTxDev((HDMITXDEV *)&InstanceData);
	HPDStatus = FALSE;
...
*/
	...
	if(Colorimetry != UserColorimetry)		Colorimetry = UserColorimetry;
