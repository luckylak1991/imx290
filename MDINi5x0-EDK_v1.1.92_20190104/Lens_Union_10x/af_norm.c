...
static void AFNORM_GetPrvJudgeBUFF(PAFN_FILT_PARAM pFILT, BYTE nID)
{
	...
	//UARTprintf("\r\n%30s:%4d[%4d] /",__FUNCTION__, pFILT->nINC, pFILT->n_UP);
	//UARTprintf("%4d[%4d] /", pFILT->nDEC, pFILT->n_DN);
	//UARTprintf("%4d[%4d] /", pFILT->zINC, pFILT->z_UP);
...
static void AFNORM_InvTopJudgeBUFF(PAFN_FILT_PARAM pFILT, BYTE nID)
{
	...
	//UARTprintf("\r\n%30s:%4d[%4d]\r\n",__FUNCTION__,pFILT->nDEC, pFILT->n_DN);
...
static void AFNORM_GetJudge_FAR(void)
{
	...
	if (AFNORM_IsDriveEnd()==TRUE) {
		...
		//UARTprintf("%x/%x\r\n",(pFILTx->nCHK&GOOD_DEC),(pFILTb->nCHK&ZERO_INC));
...
static void AFNORM_GetJudge_DEC(void)
{
	...
	if (stAFNORM.ZOOM<=stAFNORM.KNEE && (pFILTh->nCHK&HIGH_INC)==0)
